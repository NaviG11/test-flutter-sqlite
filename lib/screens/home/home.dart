...
import 'package:database/models/noteModel.dart';
import 'package:database/screens/shared/topColumn.dart';
import 'package:database/screens/views/note_view.dart';
          ...
          return AlertDialog(
            title: const Row(children: [
              Icon(
                ...
                color: Color.fromARGB(255, 136, 99, 228),
              ),
            ...
            actions: [
              ElevatedButton(
                style: ButtonStyle(
                    backgroundColor: MaterialStateProperty.all(const Color.fromARGB(255, 240, 164, 158))),
                onPressed: () async {
                  ...
                  ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
                    ...
                    backgroundColor: Color.fromARGB(255, 230, 196, 196),
                  ));
                  refreshNotes();
                },
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        CircularPercentIndicator(
                          ...
                          progressColor: Color.fromARGB(255, 137, 67, 235),
                          backgroundColor:
                              Color.fromARGB(255, 159, 126, 222),
