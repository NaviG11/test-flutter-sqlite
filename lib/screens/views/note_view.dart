  ...
  insert(NoteModel model) {
    noteDatabase.insert(model).then((respond) async {
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        ...
        backgroundColor: Color.fromARGB(255, 18, 119, 64),
      ));
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        ...
        backgroundColor: Color.fromARGB(255, 156, 119, 216),
      ));
    });
  }
  ...
  update(NoteModel model) {
    noteDatabase.update(model).then((respond) async {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(
        ...
        backgroundColor: Color.fromARGB(255, 237, 144, 144),
      ));
    });
  }
              ...
              Container(
                ...
                child: ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color.fromARGB(255, 109, 122, 195),
